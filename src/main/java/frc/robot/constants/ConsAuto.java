...
public class ConsAuto {
  ...
  static {
    // RED
    RED_POSITIONS.put(PositionName.r1,  new Pose2d(14.515532552256635, 3.859, Rotation2d.fromDegrees(0)));//14.505
    RED_POSITIONS.put(PositionName.r2,  new Pose2d(13.925, 2.892, Rotation2d.fromDegrees(-60)));//13.939 2.858//13.892989245503589, 2.815
    RED_POSITIONS.put(PositionName.r3,  new Pose2d(13.632, 2.706, Rotation2d.fromDegrees(-60)));
    RED_POSITIONS.put(PositionName.r4,  new Pose2d(12.43, 2.686, Rotation2d.fromDegrees(-120)));//12.488 2.697
    RED_POSITIONS.put(PositionName.r5,  new Pose2d(12.201, 2.868, Rotation2d.fromDegrees(-120)));
    RED_POSITIONS.put(PositionName.r6,  new Pose2d(11.591 , 3.90, Rotation2d.fromDegrees(180)));//11.624 3.68
    RED_POSITIONS.put(PositionName.r7,  new Pose2d(11.624, 4.188, Rotation2d.fromDegrees(180)));//11.624, 4.188
    ...
    RED_POSITIONS.put(PositionName.r10, new Pose2d(13.6751, 5.366, Rotation2d.fromDegrees(60)));//13.615 5.378
    RED_POSITIONS.put(PositionName.r11, new Pose2d(13.941, 5.214, Rotation2d.fromDegrees(60)));
    RED_POSITIONS.put(PositionName.r12, new Pose2d(14.119,   4.129, Rotation2d.fromDegrees(0)));//14.505
    ...
    BLUE_POSITIONS.put(PositionName.r6,  new Pose2d(5.949,  4.111, Rotation2d.fromDegrees(0)));//5.93 4.186    5.949 4.111         
    BLUE_POSITIONS.put(PositionName.r7,  new Pose2d(5.93,  3.857, Rotation2d.fromDegrees(0)));
    BLUE_POSITIONS.put(PositionName.r8,  new Pose2d(5.296, 2.805,  Rotation2d.fromDegrees(-60)));  //5.294, 2.805     //5.341 2.87     5.294  2.805
    BLUE_POSITIONS.put(PositionName.r9,  new Pose2d(5.069,  2.673, Rotation2d.fromDegrees(-60)));//
    BLUE_POSITIONS.put(PositionName.r10, new Pose2d(3.838, 2.712, Rotation2d.fromDegrees(-120)));// 3.847 2.72    
    BLUE_POSITIONS.put(PositionName.r11, new Pose2d(3.634, 2.872, Rotation2d.fromDegrees(-120)));  
    BLUE_POSITIONS.put(PositionName.r12, new Pose2d(2.90, 3.854, Rotation2d.fromDegrees(180)));//2.96
    ...
    BLUE_POSITIONS.put(PositionName.Rr,  new Pose2d(3.731, 2.695, Rotation2d.fromDegrees(-120)));
