...
public class ConsLift {
  ...
  //config
  public static final TalonFXConfiguration armAngleConfigs = new TalonFXConfiguration().withSoftwareLimitSwitch(armAngleLimit).withVoltage(armAngleVoltageLimit);
  public static final TalonFXConfiguration liftConfigs = new TalonFXConfiguration().withSlot0(liftSlot0).withSoftwareLimitSwitch(liftLimit);
