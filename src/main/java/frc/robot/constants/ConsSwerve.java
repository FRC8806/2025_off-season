...
public class ConsSwerve {
  ...
  public static final double throttleMaxSpeed = 5800 / 60 / gearRatio_L3plus * ConsSwerve.kWheelDiameter* Math.PI;
  public static final double kMaxRotationSpeed = throttleMaxSpeed / Math.sqrt(2 * Math.pow(0.5, 2)) * 2;
  ...
  // public static final Slot0Configs steerGains = new Slot0Configs().withKV(0.12).withKP(0.4).withKI(0.001).withKD(0.001);

  public static final double kThrottleConversionFactor = kWheelDiameter * Math.PI / gearRatio_L3plus;

  public static final PIDConstants TRANSLATION_PID_CONSTANTS = new PIDConstants(4.6, 0, 0);//4.6
  public static final PIDConstants ROTATION_PID_CONSTANTS = new PIDConstants(0.5, 0, 0);//2.34
